      ...
      <header className="header">
        <nav className="navbar navbar-expand-lg header-nav">
             ...
             Home
              ...
              {/* <li className={`has-submenu ${pathnames.includes('home') ? 'active' : ''}`}>
                ...
                <ul className="submenu">
                  ...
                  <li className={pathnames === '/home1' ? 'active' : ''}>
                    <Link to="/home1">Home 1</Link>
                  </li>
                  <li className={pathnames === '/home2' ? 'active' : ''}>
                    <Link to="/home2">Home 2</Link>
                  </li>
                  <li className={pathnames === '/homeslider1' ? 'active' : ''}>
                    <Link to="/homeslider1">Home slider 1</Link>
                  </li>
                  <li className={pathnames === '/homeslider2' ? 'active' : ''}>
                    <Link to="/homeslider2">Home slider 2</Link>
                  </li>
                </ul>
              </li> */}
              {/* <li className={`has-submenu ${url.includes('/doctor') ? 'active' : ''}`}>
                ...
                <ul className={`submenu`}>
                  <li className={pathnames.includes('dashboard') ? 'active' : ''}>
                    <Link to="/doctor/dashboard" onClick={() => onhandleCloseMenu()}>
                      Doctor Dashboard
                    </Link>
                  </li>
              ...
              {/* <li className={`has-submenu ${url.includes('/patient') ? 'active' : ''}`}>
                ...
                <ul className={`submenu`}>
                  <li className={`has-submenu ${pathnames.includes('doctor') ? 'active' : ''}`}>
                    ...
                    <ul className="submenu">
                      <li className={pathnames.includes('doctor-grid') ? 'active' : ''}>
                        <Link to="/patient/doctor-grid" onClick={() => onhandleCloseMenu()}>
                          Map Grid
                        </Link>
                      </li>
                  ...
                  <li className={pathnames.includes('search-doctor') ? 'active' : ''}>
                    <Link to="/patient/search-doctor" onClick={() => onhandleCloseMenu()}>
                      Search Doctor
                    </Link>
                  </li>
                  ...
                  <li className={pathnames.includes('booking') ? 'active' : ''}>
                    <Link to="/patient/booking" onClick={() => onhandleCloseMenu()}>
                      Booking
                    </Link>
                  </li>
                  ...
                  <li className={pathnames.includes('favourites') ? 'active' : ''}>
                    <Link to="/patient/favourites" onClick={() => onhandleCloseMenu()}>
                      Favourites
                    </Link>
                  </li>
                  <li className={pathnames.includes('patient-chat') ? 'active' : ''}>
                    <Link to="/patient/patient-chat" onClick={() => onhandleCloseMenu()}>
                      Chat
                    </Link>
                  </li>
              ...
              {/* <li className={`has-submenu ${url.includes('/pages') ? 'active' : ''}`}>
                ...
                <ul className={`submenu`}>
                  <li className={`${pathnames.includes('/voice-call') ? 'active' : ''}`}>
                    <Link to="/pages/voice-call" onClick={() => onhandleCloseMenu()}>
                      Voice Call
                    </Link>
                  </li>
                  <li className={`${pathnames.includes('/video-call') ? 'active' : ''}`}>
                    <Link to="/pages/video-call" onClick={() => onhandleCloseMenu()}>
                      Video Call
                    </Link>
                  </li>

                  <li className={`${pathnames.includes('/calendar') ? 'active' : ''}`}>
                    <Link to="/pages/calendar" onClick={() => onhandleCloseMenu()}>
                      Calendar
                    </Link>
                  </li>
              ...
              {/* <li className="has-submenu">
                ...
                <ul className="submenu">
                  ...
                  <li>
                    <a href="/pharmnacyadmin" target="_blank" to="/pharmacyadmin">
                      Pharmacy Admin
                    </a>
                  </li>
                </ul>
          ...
          <ul className="nav header-navbar-rht">
            ...
            {window.location.pathname === '/pages/voice-call' ||
            window.location.pathname === '/pages/video-call' ? (
              <>
                <Dropdown className="user-drop nav-item dropdown has-arrow logged-item">
                  <Dropdown.Toggle variant="success" id="dropdown-basic">
                    <img className="rounded-circle" src={IMG01} width="31" alt="Darren Elder" />
                  </Dropdown.Toggle>
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item href="/doctor/doctor-dashboard">Dashboard</Dropdown.Item>
                    <Dropdown.Item href="/doctor/profile-setting">Profile Settings</Dropdown.Item>
