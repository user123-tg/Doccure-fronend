...
import { IMG01, IMG02, IMG03, IMG04, IMG05, IMG06, IMG07 } from '../doctor/img';
                  ...
                  <div className="doc-info-left">
                    ...
                    <div className="doc-info-cont">
                      ...
                      <p className="doc-department">
                        <img src={IMG02} className="img-fluid" alt="Speciality" /> Dentist
                      </p>
                      ...
                      <div className="clinic-details">
                        <p className="doc-location">
                          ...
                          <a href="#0">Get Directions</a>
                        </p>
                        <ul className="clinic-gallery">
                          <li>
                            <a
                              href="#0"
                              onClick={() => setState(...state, { isOpen: true, photoIndex: 0 })}>
                              <img
                                src={IMG03}
                                alt="Feature"
                          ...
                          <li>
                            <a
                              href="#0"
                              onClick={() => setState(...state, { isOpen: true, photoIndex: 1 })}>
                              <img
                                src={IMG04}
                                alt="Feature"
                                style={{ borderRadius: '5px', width: '40px' }}
                          ...
                          <li>
                            <a
                              href="#0"
                              onClick={() => setState(...state, { isOpen: true, photoIndex: 2 })}>
                              <img
                                src={IMG05}
                                alt="Feature"
                                style={{ borderRadius: '5px', width: '40px' }}
                          ...
                          <li>
                            <a
                              href="#0"
                              onClick={() => setState(...state, { isOpen: true, photoIndex: 3 })}>
                              <img
                                src={IMG06}
                                alt="Feature"
                                style={{ borderRadius: '5px', width: '40px' }}
                          ...
                          <div className="col-md-6">
                            <div className="clinic-content">
                              <h4 className="clinic-name">
                                <a href="#0">Smile Cute Dental Care Center</a>
                              </h4>
                              ...
                              <div className="clinic-details mb-0">
                                <h5 className="clinic-direction">
                                  <i className="fas fa-map-marker-alt"></i> 2286 Sundown Lane,
                                  Austin, Texas 78749, USA <a href="#0">Get Directions</a>
                                </h5>
                                <div>
                                  {state.isOpen && (
                                    <Lightbox
                      ...
                      <div className="location-list">
                        <div className="row">
                          <div className="col-md-6">
                            <div className="clinic-content">
                              <h4 className="clinic-name">
                                <a href="#0">The Family Dentistry Clinic</a>
                              </h4>
                              <p className="doc-speciality">
                                MDS - Periodontology and Oral Implantology, BDS
                              </p>
                              ...
                              <div className="clinic-details mb-0">
                                <p className="clinic-direction">
                                  ...
                                  2883 University Street, Seattle, Texas Washington, 98155
                                  <a href="#0">Get Directions</a>
                                </p>
                                <div>
                                  {state.isOpen && (
                  ...
                  <Tab className="nav-item" eventKey={3} title="Reviews">
                    <div>
                                ...
                                <div className="comment">
                                  ...
                                  <div className="comment-body">
                                    ...
                                    <p className="comment-content">
                                      ...
                                      Ut enim ad minim veniam. Curabitur non nulla sit amet nisl
                                      tempus
                                    </p>
                                    <div className="comment-reply">
                                      <a className="comment-btn" href="#0">
                      ...
                      <div className="write-review">
                        <h4>
                          Write a review <strong>Dr. Darren Elder</strong>
                        </h4>
