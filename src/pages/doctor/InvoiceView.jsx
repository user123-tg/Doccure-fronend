                ...
                <div className="invoice-content">
                      ...
                      <div className="col-md-6">
                        <div className="invoice-info">
                          ...
                          <p className="invoice-details invoice-details-two">
                            Dr. Darren Elder 806 Twin Willow Lane, Old Forge Newyork, USA
                          </p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="invoice-info invoice-info2">
                          ...
                          <p className="invoice-details">
                            Walter Roberson 299 Star Trek Drive, Panama City, Florida, 32405, USA
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="other-info">
                    ...
                    <p className="text-muted mb-0">
                      ...
                      ligula, cursus blandit risus. Maecenas eget metus non tellus dignissim aliquam
                      ut a ex. Maecenas sed vehicula dui, ac suscipit lacus. Sed finibus leo vitae
                      lorem interdum, eu scelerisque tellus fermentum. Curabitur sit amet lacinia
                      lorem. Nullam finibus pellentesque libero.
                    </p>
                  </div>
                </div>
              </div>
